...
std::vector<cv::Point2f> operator -(const std::vector<cv::Point2f>& vec1,const std::vector<cv::Point2f> &vec2);
std::vector<cv::Point2f> OFCal(const std::vector<cv::Point2f> &pixels,const cv::Mat &frame1, const cv::Mat &frame2,std::vector<uchar> &status);
...
std::vector<cv::Point3f> Pixel23D(std::vector<cv::Point2f> &keypoints_1,const cv::Mat &img1,const cv::Mat &img2);
...
void KeypointDynamicOpticalDef(std::vector<cv::Point2f> &keypoints_1,const cv::Mat &img1,const cv::Mat &img2,std::vector<cv::Point2f> &static_kps, std::vector<cv::Point2f> &dynamic_kps, double threshold);
std::vector<cv::Point2f> OpticalDefStatic(std::vector<cv::Point2f> &keypoints_1,const cv::Mat &img1,const cv::Mat &img2, double threshold);
...
std::vector<float> Pixel23D(std::vector<cv::KeyPoint> &keypoints_1,const cv::Mat &img1,const cv::Mat &img2);
...
void KeypointDynamicOpticalDef(std::vector<cv::KeyPoint> &keypoints_1,const cv::Mat &img1,const cv::Mat &img2,std::vector<cv::KeyPoint> &static_kps, std::vector<cv::KeyPoint> &dynamic_kps, double threshold);
std::vector<cv::KeyPoint> OpticalDefStatic(std::vector<cv::KeyPoint> &keypoints_1,const cv::Mat &img1,const cv::Mat &img2, double threshold);
